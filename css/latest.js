    ...
    database.once('value', function(snapshot){
        if(snapshot.exists()){
            ...
            snapshot.forEach(function(data){
            	...
            	content += `<div class='eventItem col-sm-6 mx-2 my-1'>
							...
							<ul class="row">
								...
								<li class='eventIt eventLocation col-sm-4'>Location</li>
							...
							<a href="`+iGroup.link+`" class="btn btn-info btn-lg active" role="button" aria-pressed="true">`+iGroup.name+` Group</a>
						</div>`;
